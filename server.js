    ...
    try {
      new ExifImage({ image : filename }, function (error, exifData) {
        if (error){
          ...
          var make = (typeof exifData.image.Make != 'undefined') ? exifData.image.Make : "n/a";
          var model = (typeof exifData.image.Model != 'undefined') ? exifData.image.Model : "n/a";
          var createdon = (typeof exifData.exif.CreateDate != 'undefined') ? exifData.exif.CreateDate : "n/a";
          ...
          console.log('Make: '+ exifData.image.Make);
            ...
            if (typeof exifData.gps.GPSLatitude != 'undefined'){
